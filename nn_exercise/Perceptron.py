...
class Perceptron:
    ...
    #     """
    #
    #     # result = np.zeros(shape=[input_matrix.shape[0], 1])
    #     # w - вектор весов размера (m, 1), где m - количество переменных
    #     result = (input_matrix @ self.w + self.b) > 0
    #     return result
    ...
    def train_until_covergence(self, input_matrix, y, max_steps=1e8):
        """
